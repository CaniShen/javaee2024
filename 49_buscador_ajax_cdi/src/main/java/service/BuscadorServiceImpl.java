...
public class BuscadorServiceImpl implements BuscadorService {
	...
	@Inject
	@Named("buscador1")//--> si solo hay una implementacion no hace falta poner eso
	BuscadorDao dao;
	//si la url no está siendo utilizado por otro resultado, se dará de alta
	@Override
